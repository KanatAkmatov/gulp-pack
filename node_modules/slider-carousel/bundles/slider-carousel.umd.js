(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/platform-browser'), require('rxjs'), require('util')) :
    typeof define === 'function' && define.amd ? define('slider-carousel', ['exports', '@angular/core', '@angular/common', '@angular/platform-browser', 'rxjs', 'util'], factory) :
    (global = global || self, factory(global['slider-carousel'] = {}, global.ng.core, global.ng.common, global.ng.platformBrowser, global.rxjs, global.util));
}(this, (function (exports, core, common, platformBrowser, rxjs, util) { 'use strict';
    ...
    var Helper = /** @class */ (function () {
        ...
        Helper.prototype.elementIsChild = function (element, parentElment) {
            try {
                while (!util.isNullOrUndefined(element) && element.tagName.toUpperCase() !== 'BODY') {
